...
<div class="container-fluid d-flex flex-column flex-lg-row app-main flex-column flex-row-fluid py-lg-10 px-lg-10"
	...
	<div class=" flex-column flex-row-fluid" id="kt_app_wrapper">
		...
		<!--form start -->
		<form id="teamEdit" method="post" enctype="multipart/form-data">
			<input type="hidden" name="teamEditId" value="<?=$member['id']?>">
			<button class="btn btn-primary editTeamBtn d-flex" style="margin-left: auto">Save</button>
			...
			<div class="tab-content mt-5 padding-left" id="myTabContent">
				...
				<div class="input-group mb-10">
					<div>
						...
						<div class="image-input image-input-empty mt-2" data-kt-image-input="true">
							...
							<div class="image-input-wrapper img-image-input-wrapper w-125px h-125px" id="frame" style="background-image: url('<?=$member['image']?>')"></div>
							...
							<label class="btn btn-icon btn-circle btn-color-muted btn-active-color-primary w-25px h-25px bg-body shadow"
								...
								<input type="hidden" name="image_old" value="<?=$member['image']?>">
								<!--end::Inputs-->
							</label>
							<!--end::Edit button-->
				...
				<div class="input-group mb-10">
					<div>
						...
						<div class="image-input image-input-empty mt-2" data-kt-image-input="true">
							<!--begin::Image preview wrapper-->
							<div class="image-input-wrapper img-image-input-wrapper w-125px h-125px" id="frame2" style="background-image: url('<?=$member['logo_image']?>')"></div>
							<!--end::Image preview wrapper-->
							...
							<label class="btn btn-icon btn-circle btn-color-muted btn-active-color-primary w-25px h-25px bg-body shadow"
								...
								<input type="hidden" name="logo_image_old" value="<?=$member['logo_image']?>">
								<!--end::Inputs-->
							</label>
							<!--end::Edit button-->
				...
				<div class="tab-pane fade show active mt-5" id="kt_tab_pane_1"
					...
					<div class="mb-10">
						...
						<input type="text" id="title" name="title_en" class="form-control form-control-solid" placeholder="Name and Surname" value="<?=$member['title_en']?>">
					</div>

					<div class="mb-10">
						<label for="role" class="form-label mt-7 mb-4">Role</label>
						<input type="text" id="role" name="role_en" class="form-control form-control-solid" placeholder="Role" value="<?=$member['role_en']?>">
					</div>

					<div class="mb-10">
						<label class="form-label mt-7 mb-4" for="location_en">Location</label>
						<input type="text" id="location_en" name="location_en" class="form-control form-control-solid" placeholder="Location" value="<?=$member['location_en']?>">
					</div>

					<div class="mb-10">
						<label class="form-label mt-7 mb-4" for="info">Information</label>
						<textarea name="info_en" id="kt_docs_ckeditor_classic"><?=$member['info_en']?></textarea>
					</div>
				...
				<div class="tab-pane fade mt-5" id="kt_tab_pane_2" role="tabpanel">
					<div class="mb-10">
						<label for="title" class=" form-label mt-7 mb-4">Name and Surname</label>
						<input type="text" id="title" name="title_am" class="form-control form-control-solid" placeholder="Name and Surname" value="<?=$member['title_am']?>">
					</div>

					<div class="mb-10">
						<label for="role" class="form-label mt-7 mb-4">Role</label>
						<input type="text" id="role" name="role_am" class="form-control form-control-solid" placeholder="Role" value="<?=$member['role_am']?>">
					</div>

					<div class="mb-10">
						<label class="form-label mt-7 mb-4" for="location_en">Location</label>
						<input type="text" id="location_en" name="location_am" class="form-control form-control-solid" placeholder="Location" value="<?=$member['location_en']?>">
					</div>

					<div class="mb-10">
						<label class="form-label mt-7 mb-4" for="info">Information</label>
						<textarea name="info_am" id="kt_docs_ckeditor_classic"><?=$member['info_am']?></textarea>
					</div>
				</div>
				<!--tab2 end -->
...
<script>
    $(document).ready(function () {
        ...
        $('#teamEdit').on('submit', function (e) {
            e.preventDefault();
            $('.editTeamBtn').attr('disabled', 'disabled');
