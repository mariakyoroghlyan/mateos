        ...
        <div class="d-flex flex-stack flex-wrap mb-5">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-docs-table-filter="search"
                       class="form-control form-control-solid w-250px ps-15" placeholder="Zoek Agenda's">
            </div>
            <!--end::Search-->
            <!--begin::Toolbar-->
            <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                <!--begin::Add customer-->
                <a href="/admin/admin-agenda-add" class="btn" style="background: rgba(65, 29, 11, 1); color: white"
                   data-bs-toggle="tooltip"
                   data-bs-original-title="Add Agenda" data-kt-initialized="1">
                    ...
                    <table id="kt_datatable_zero_configuration"
                        ...
                        foreach ($agendas as $agenda) { ?>
                            <tr class="even">
                                ...
                                <td>
                                    <img src="<?php echo isset($agenda['image']) && !empty($agenda['image']) ? $agenda['image'] : '/assets/media/svg/files/blank-image.svg'; ?>"
                                         width="70px" height="70px" alt="img" style="object-fit: cover">
                                </td>
                                <td>
                                    <?= strlen($agenda['desc-nl']) > 20 ? substr($agenda['desc-nl'], 0, 20) . '...' : $agenda['desc-nl'] ?>
                                </td>
                                <td><?= $agenda['date'] ?></td>
                                <td>
                                    <div class="badge <?= $agenda['status'] == 1 ? 'badge-success' : 'badge-danger' ?> ">
                                        <?= $agenda['status'] == 1 ? 'active' : 'inactive' ?>
                                    </div>
                                </td>
                                <td class="d-flex">
                                    <a href="/admin/admin-agenda-edit?id=<?= $agenda['id'] ?>"
                                    ...
                                    <a href="/admin/agenda-delete-function?id=<?= $agenda['id'] ?>"
...
<script>
    const projects = [
        <?php foreach ($agendas as $project): ?>
        {
            id: <?= $project['id']; ?>,
...
<td><img src="${project.image && project.image !== '' ? project.image : '/assets/media/svg/files/blank-image.svg'}" width="100px" height="100px" alt="img" style="object-fit: cover"></td>
                ...
                <td class="d-flex">
               <a href="/admin/admin-agenda-edit?id=${project.id}"
                                    ...
                                    <a href="/admin/agenda-delete-function?id=${project.id}" class="btn btn-sm d-flex align-items-center justify-content-center" style="border: 1px solid rgba(65, 29, 11, 1); width: min-content">Verwijderen
                                        <i class="fa-solid fa-trash ms-2 text-black"></i>
                                   </a>
                </td>
            </tr>`).join('');
