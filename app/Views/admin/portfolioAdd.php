...
<div class="container-fluid d-flex flex-column flex-lg-row app-main flex-column flex-row-fluid py-lg-10 px-lg-10"
	...
	<div class=" flex-column flex-row-fluid" id="kt_app_wrapper">
		...
		<!--form start -->
		<form id="portfolioAdd" method="post" enctype="multipart/form-data">

			<button class="btn btn-primary addPortfolioBtn d-flex" style="margin-left: auto">Save</button>
			...
			<div class="tab-content mt-5 padding-left" id="myTabContent">
                ...
                <div class="mb-10">
                    ...
                    <input type="number" step="0.01" id="text" name="cost" class="form-control form-control-solid" placeholder="Cost">
				...
				<div class="tab-pane fade show active mt-5" id="kt_tab_pane_1"
                    ...
                    <div class="mb-10 d-flex align-items-center">
                        ...
                        <input type="text" id="category" name="category_en" class="form-control form-control-solid" placeholder="Category">
                    </div>

                    <div class="mb-10">
						<label for="company" class="form-label mt-7 mb-4">Company</label>
						<input type="text" id="company" name="company_en" class="form-control form-control-solid" placeholder="Company">
					</div>

					<div class="mb-10">
						<label class="form-label mt-7 mb-4" for="status">Status</label>
                        <input type="text" id="status" name="status_en" class="form-control form-control-solid" placeholder="Status">
                    </div>

                    <div class="mb-10">
                        <label class="form-label mt-7 mb-4" for="information">Information</label>
                        <textarea name="text_en" id="kt_docs_ckeditor_classic"></textarea>
                    </div>
				...
				<div class="tab-pane fade mt-5" id="kt_tab_pane_2" role="tabpanel">
                    <div class="mb-10 d-flex align-items-center">
                        ...
                        <input type="text" id="category" name="category_am" class="form-control form-control-solid" placeholder="Category">
                    </div>

                    <div class="mb-10">
                        <label for="company" class="form-label mt-7 mb-4">Company</label>
                        <input type="text" id="company" name="company_am" class="form-control form-control-solid" placeholder="Company">
                    </div>

                    <div class="mb-10">
                        <label class="form-label mt-7 mb-4" for="status">Status</label>
                        <input type="text" id="status" name="status_am" class="form-control form-control-solid" placeholder="Status">
                    </div>

                    <div class="mb-10">
                        <label class="form-label mt-7 mb-4" for="information">Information</label>
                        <textarea name="text_am" id="kt_docs_ckeditor_classic"></textarea>
                    </div>
				</div>
				<!--tab2 end -->
...
<script>
    $(document).ready(function () {
        ...
        $('#portfolioAdd').on('submit', function (e) {
            e.preventDefault();
            $('.addPortfolioBtn').attr('disabled', 'disabled');

            $.ajax({
                url: '/admin/portfolioAdd',
                type: 'POST',
