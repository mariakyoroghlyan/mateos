...
<div class="container-fluid d-flex flex-column flex-lg-row app-main flex-column flex-row-fluid py-lg-10 px-lg-10"
	...
	<div class=" flex-column flex-row-fluid" id="kt_app_wrapper">
		...
		<!--form start -->
		<form id="editPortfolioText" method="post" enctype="multipart/form-data">
			<input type="hidden" value="<?=$portfolio['id']?>" name="editPortfolioId">
			...
			<div class="tab-content mt-5 padding-left" id="myTabContent">
				...
				<div class="tab-pane fade show active mt-5" id="kt_tab_pane_1"
					...
					<div class="mb-10">
						...
						<input type="text" id="text_en" name="text_en" class="form-control form-control-solid" placeholder="Title" value="<?=$portfolio['text_en']?>">
					</div>
				</div>
				<!--tab1 end -->
				...
				<div class="tab-pane fade show mt-5" id="kt_tab_pane_2" role="tabpanel">
					...
					<div class="mb-10">
						...
						<input type="text" id="text_am" name="text_am" class="form-control form-control-solid" placeholder="Text" value="<?=$portfolio['text_am']?>">
					</div>
...
<script>
    $(document).ready(function () {
        ...
        $('#editPortfolioText').on('submit', function (e) {
            e.preventDefault();
            $('.editPortfolioTextBtn').attr('disabled', 'disabled');

            $.ajax({
                url: '/admin/portfolioTextChange',
                type: 'POST',
