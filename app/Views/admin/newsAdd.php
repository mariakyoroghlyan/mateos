...
<div class="container-fluid d-flex flex-column flex-lg-row app-main flex-column flex-row-fluid py-lg-10 px-lg-10"
    ...
    <div class=" flex-column flex-row-fluid" id="kt_app_wrapper">
        <h1 class="mb-5">Nieuwsartikel toevoegen</h1>
    ...
    <form id="newsAdd" method="post" enctype="multipart/form-data">
        ...
        <button class="btn addNewsBtn d-flex text-white align-items-center" style="margin-left: auto; background: rgba(65, 29, 11, 1);">
...
<!--main fixed-->
            ...
            <div class="tab-pane fade show active mt-5" id="kt_tab_pane_1" role="tabpanel">
                ...
                <div class="mb-10">
                    ...
                    <input type="text" id="author" name="author-nl" class="form-control form-control-solid" placeholder="Author" >
                </div>
            ...
            <div class="tab-pane fade mt-5" id="kt_tab_pane_2" role="tabpanel">
                ...
                <div class="mb-10">
                    ...
                    <input type="text" id="author" name="author-am" class="form-control form-control-solid" placeholder="Author" >
                </div>
            ...
            <div class="tab-pane fade mt-5" id="kt_tab_pane_3"
                ...
                <div class="mb-10">
                    ...
                    <input type="text" id="author" name="author-en" class="form-control form-control-solid" placeholder="Author" >
                </div>
